...
const HomeCopy = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-white bg-black">
      {/* <img
        // src={bgImage}
        src="https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0Nzg4MjV8MHwxfHJhbmRvbXx8fHx8fHx8fDE2OTAwOTkxOTl8&ixlib=rb-4.0.3&q=80&w=1080"
        alt="unsplash"
        className="w-full h-full overflow-hidden absolute top-0 left-0 opacity-10"
      /> */}
      <div className="fixed top-0 left-0 right-0 p-4 flex justify-between items-center">
        <div className="flex flex-col justify-center items-start">
          ...
          <p className="text-2xl font-200">{date}</p>
        </div>
        <div className="flex space-x-4">
          ...
          <form
            ...
            className="relative"
          >
            <label htmlFor="" className="absolute px-4 py-2">
              <svg
                aria-hidden="true"
                width="23"
                height="23"
            ...
            <input
              type="text"
              className="border-0 md:min-w-[600px] min-w-[200px] outline-none focus:outline-none  rounded-full pl-16 pr-4 pt-[7px] pb-[9px] transition-all ease-in-out duration-75 focus:bg-opacity-[12%] bg-opacity-10 bg-white text-white"
      ...
      {/* Body with Random Image */}
      <div className="bg-cover bg-center flex-1 w-full flex items-center justify-center">
        {/* Favorite Sites Tiles */}
        {/* ... (same as in the previous code) ... */}
      </div>
    </div>
  );
